...
class DrawCanvasExample extends StatefulWidget {
  @override
  _DrawCanvasExampleState createState() => _DrawCanvasExampleState();
}

class _DrawCanvasExampleState extends State<DrawCanvasExample> {
  @override
